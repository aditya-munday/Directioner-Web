  ...
  useEffect(() => {
    ...
    const waitForSession = async () => {
      ...
      while (isMounted && Date.now() - start < timeoutMs) {
        ...
        if (err) {
          // Don't expose raw error — log in dev, show generic message in UI
          if (import.meta.env.DEV) console.warn('[Auth callback]', err.message);
      ...
      setError('Sign-in timed out. Please return to the login page and try again.');
    };
